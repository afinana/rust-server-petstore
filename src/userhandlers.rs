...
pub async fn add_user(data: web::Data<Mutex<RedisDb>>, new_user: web::Json<User>) -> impl Responder {
...
pub async fn get_user_by_username(data: web::Data<Mutex<RedisDb>>, username: web::Path<String>) -> impl Responder {
	// log request
...
pub async fn update_user_by_username(data: web::Data<Mutex<RedisDb>>, username: web::Path<String>, new_user: web::Json<User>) -> impl Responder {
	// log request
...
pub async fn delete_user_by_username(data: web::Data<Mutex<RedisDb>>, username: web::Path<String>) -> impl Responder {
	// log request
...
pub async fn login_user(data: web::Data<Mutex<RedisDb>>, username: web::Path<String>, password: web::Path<String>) -> impl Responder {
	// log request
	...
	match redis_db.get_users() {
		Ok(users) => {
			...
			log::info!("Failed to login user {:?} , error: User not found", username);
...
pub async fn create_users_with_list(data: web::Data<Mutex<RedisDb>>, new_users: web::Json<Vec<User>>) -> impl Responder {
	// log request
